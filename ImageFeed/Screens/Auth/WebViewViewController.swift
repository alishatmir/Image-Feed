...
final class WebViewViewController: UIViewController {
    ...
    lazy private var authWebView: WKWebView = {
        let authWebView = WKWebView()
        authWebView.backgroundColor = .ypWhite
    ...
    private func removeCookies() {
        HTTPCookieStorage.shared.removeCookies(since: Date(timeIntervalSince1970: .zero))
